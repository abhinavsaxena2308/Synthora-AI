      ...
      <section className="py-20">
        <div className="container px-4 max-w-3xl">
          ...
          <div className="prose-sm space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>By using SynthoraAI, you agree to these terms. If you don't agree, please don't use our services.</p>
            <h2 className="text-xl font-semibold text-foreground">2. Use of Services</h2>
            <p>You may use SynthoraAI to generate AI content for personal and commercial purposes. You retain ownership of content you create, subject to our AI model providers' terms.</p>
            ...
            <p>Generated content is yours to use. SynthoraAI's platform, branding, and technology remain our intellectual property.</p>
            <h2 className="text-xl font-semibold text-foreground">5. Limitation of Liability</h2>
            <p>SynthoraAI is provided "as is" without warranties. We are not liable for any damages arising from use of our services.</p>
          </div>
        </div>
      </section>
    </PageLayout>
